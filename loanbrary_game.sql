...
CREATE TABLE `game` (
  ...
  PRIMARY KEY (`id_item`),
  KEY `game_developer_fk_idx` (`id_developer`),
  CONSTRAINT `game_developer_fk` FOREIGN KEY (`id_developer`) REFERENCES `developer` (`id_developer`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `game_item_fk` FOREIGN KEY (`id_item`) REFERENCES `item` (`id_item`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='Table that stores the information from the games registered in the system.';
...
-- Dump completed on 2021-05-28 20:09:48
