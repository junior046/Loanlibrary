...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='Table that stores the information from the editorials registered in the system.';
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `editorial_BEFORE_INSERT` BEFORE INSERT ON `editorial` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `editorial_BEFORE_UPDATE` BEFORE UPDATE ON `editorial` FOR EACH ROW BEGIN
...
-- Dump completed on 2021-05-28 20:10:01
