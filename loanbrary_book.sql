...
CREATE TABLE `book` (
  ...
  KEY `book_editorial_fk_idx` (`id_editorial`),
  CONSTRAINT `book_editorial_fk` FOREIGN KEY (`id_editorial`) REFERENCES `editorial` (`id_editorial`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Table that stores the information from the books  registered in the system.';
...
-- Dump completed on 2021-05-28 20:10:00
